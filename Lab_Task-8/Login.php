  ...
  <li><a class="active" href="./Registration1.php"><b style="color: orange;"> Sign Up</a></li>
        ...
        <div class="form_container">
            <form name="myform" method="post" action="" onsubmit="validateform()">
                <h2 style="color: black; text-align: left; font-size: 40px;"><b style="color: black;"> Login</h2><br>
                <table align="center">
                    <tr>
                        <td style="color: black;"><b style="color: red;"> Username:</td>
                    ...
                    <tr>
                        <td style="color: black;"><b style="color: red;"> Password:</td>
