...
<ul>
 <li><a class="active" href="./index.php"><b style="color: orange;"> Home</a></li>
  <li><a class="active" href="./Login.php"><b style="color: orange;"> Log In</a></li>
  <li><a class="active" href="./Registration1.php"><b style="color: orange;"> Sign Up</a></li>
</ul>
		...
		<div class="form_container">
			<form name="myform" method="post" action="" onsubmit="validateform()">
				<table align="center">
					...
					<tr>
						<td style="color: blue;">&nbsp; House No.:</td>
					...
					<tr>
						<td style="color: blue;">&nbsp; Road No.:</td>
					...
					<tr>
						<td style="color: blue;">&nbsp; Block No.:</td>
					...
					<tr>
					<td style="color: blue;"><br>&nbsp;&nbsp;Division:</td>
					...
					<tr>
						<td style="color: blue;">&nbsp;&nbsp;District:</td>
					...
					<tr>
						<td style="color: blue;">&nbsp;&nbsp;Phone Number:</td>
