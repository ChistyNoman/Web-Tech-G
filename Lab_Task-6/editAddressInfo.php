    ...
    <div>
        ...
        <form action="" method="post">  
                <table align="center">
                    <tr>
                        <td>
                           <b style="color: red;"> Address Information:<br>
                        </td>
                        <td>
                           <b style="color: darkblue;"> House <input onfocusout="checkH(this)" type="text" name="house" id="house" placeholder="House No" value="<?php echo $addr_house ?>"><br>
