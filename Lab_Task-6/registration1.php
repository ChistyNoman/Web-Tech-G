...
<html>
	...
	<body>
		...
		<div class="progress">
			<h3>
				<span style="color: #000000;"><b style="color: darkblue;"> Step 1 > </span>
				<span><b style="color: darkblue;"> Step 2 > </span>
				<span><b style="color: darkblue;"> Step 3 </span>
		...
		<div >
			<form action="" method="POST">
				...
				<table align="center">
					<tr>
						<td><b style="color: red"> Username:</td>
					...
					<tr>
						<td><b style="color: red;"> Confirm Password:</td>
