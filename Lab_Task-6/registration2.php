	...
	<div class="progress">
		...
		<div class="form_container">
			<form method="POST">
				<table align="center">
					<tr>
						<td><h3><u>Address Information:</u></h3></td>
					</tr>
					<tr>
					...
					<tr>
					<td><br><b style="color: red;"> Division:</td>
