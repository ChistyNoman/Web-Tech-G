	...
	<div class="progress">
		...
		<div class="form_container">
			<form name="myform" method="post" action="" onsubmit="validateform()">
				<table align="center">
					<tr>
						<h2 style="color:orange;">Address Information:</h2><br>
						
					</tr>
					<tr>
						<td style="color: red;">&nbsp; House No.:</td>
					...
					<tr>
						<td style="color: red;">&nbsp; Block No.:</td>
					...
					<tr>
					<td style="color: red;"><br>&nbsp;&nbsp;Division:</td>
